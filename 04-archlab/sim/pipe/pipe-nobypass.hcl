...
bool data_hazard =
	(d_srcA != RNONE && d_srcA in { E_dstE, e_dstE, M_dstM, M_dstE, W_dstM, W_dstE })
	||
	(d_srcB != RNONE && d_srcB in { E_dstE, e_dstE, M_dstM, M_dstE, W_dstM, W_dstE });

bool jxx = (E_icode == IJXX && !e_Cnd);

bool ret = IRET in {D_icode, E_icode, M_icode};

bool F_bubble = 0;
bool F_stall = (data_hazard || ret) && !jxx;

# Should I stall or inject a bubble into Pipeline Register D?
# At most one of these can be true.
bool D_stall = data_hazard && !jxx;
bool D_bubble = jxx || (!data_hazard && ret);

# Should I stall or inject a bubble into Pipeline Register E?
# At most one of these can be true.
bool E_stall = 0;
bool E_bubble = jxx || data_hazard;
